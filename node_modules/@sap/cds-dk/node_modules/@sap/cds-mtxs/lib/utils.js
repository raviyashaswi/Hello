...
async function fetchResiliently(url, req, retriesLeft = maxRetries, maxRetryAfter = 5000) {
  req.method ??= 'GET'
  try {
    ...
    delay = Math.max(minDelay, maxDelay * (1 + Math.tanh(steepness * (attempt - midpoint))) / 2)
    await new Promise((resolve) => setTimeout(resolve, delay))
    return fetchResiliently(url, req, retriesLeft - 1)
  }
}

// TODO define max accaptable retry-after value?
