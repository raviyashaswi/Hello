...
module.exports = class Html5RepoTemplate extends require('../../plugin') {
    ...
    async combine() {
        ...
        const {
            ...
            hasApprouter, addApprouter, addContainerize, addKyma, addHelm, addHelmUnifiedRuntime,  addMultitenancy, addWorkzoneStandard, addXsuaa,
            addSample, hasMta, addMta, hasXsuaa, hasMultitenancy, hasUI5
        } = project
        ...
        if (addMta || (addXsuaa || addApprouter || addWorkzoneStandard || addMultitenancy || addSample) && hasMta) {
